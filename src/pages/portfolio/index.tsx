        ...
        <div className="content">
          <section className="carouselRight">
            <p>
              ...
              onde foi feito uma plataforma responsiva e mobile friendly para o
              corretor poder cadastrar os imóveis que seriam vendidos.
              <br />
              <br />
              <br />
          ...
          <section className="carouselLeft">
            ...
            >
              <div>
                <img src={GitHubExplorer1} alt="github-explorer work print 1" />
              </div>
              <div>
                <img src={GitHubExplorer2} alt="github-explorer work print 2" />
              </div>
            </Carousel>
            <p>
              Trabalho realizado acompanhando o curso GoStack da Rocketseat, do
              qual consumimos a api pública do github para listar o os
          ...
          <section className="carouselRight">
            <p>
              ...
              <br />
              <br />
              Tecnologias utilizadas: HTLM, CSS, Typescript, React JS e Node.js.
            </p>
            <Carousel
              autoPlay
              infiniteLoop
          ...
          <section className="carouselLeft">
            ...
            <p>
              Trabalho realizado durante a semana omnistack 11 da rocketseat, do
              qual criamos uma aplicação que armazena e mostra os casos das ONGs
              cadastradas, permitindo o usuario entrar em contato com a ONG para
              ajudar.
              <br />
              <br />
              <br />
              Tecnologias utilizadas: HTLM, CSS, Javascript, React JS e Node.js.
            </p>
          </section>
        </div>
      </Container>
